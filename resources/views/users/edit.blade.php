    ...
    <div class="row">
            ...
            <div class="col-5">
                <div class="form-group">
                    <img src="/uploads/avatars/{{ $user->avatar }}" class="border img-fluid rounded-circle mx-auto d-block"
                        style="max-width: 200px" alt="User Avatar" height="200" />

                    <div class="row justify-content-center pt-4">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="avatar">User Image</label>
                            <input type="file" id="avatar" name="avatar" class="form-control" value="{{ $user->avatar }}">
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <button class="btn btn-danger" onclick="location.href='/users/7'" type="button">Back</button>
                </div>
